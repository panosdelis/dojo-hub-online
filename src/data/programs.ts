...
export const programs: ProgramData[] = [
  {
    ...
    shortDescription: "Ολοκληρωμένη αυτοάμυνα για κάθε πραγματική απειλή",
    icon: Target,
  },
  {
    slug: "fcs-kali",
    ...
    shortDescription: "Ρεαλιστική μάχη με όπλα και άοπλη αντιμετώπιση.",
    icon: Swords,
  },
  {
    slug: "mma",
    ...
    shortDescription: "Πλήρης μάχη με χτυπήματα και λαβές.",
    icon: Trophy,
  },
  {
    ...
    shortDescription: "Κάψε θερμίδες, μάθε να μάχεσαι.",
    icon: Activity,
  },
  {
    slug: "capoeira",
    ...
    shortDescription: "Ρυθμός, κίνηση και ελευθερία μέσα από τη μάχη.",
    icon: Zap,
  },
  {
    slug: "pilates",
    ...
    shortDescription: "Ενδυνάμωση σώματος και πνεύματος.",
    icon: Heart,
  },
  {
    slug: "personal-training",
    title: "Personal Training",
    description: "Εξατομικευμένη προπόνηση που σχεδιάζεται αποκλειστικά για τους στόχους σου, το επίπεδό σου και τις ανάγκες σου, με σκοπό τη μέγιστη απόδοση, πρόοδο και ασφάλεια σε κάθε στάδιο της εξέλιξής σου.",
    shortDescription: "Εξατομικευμένη προπόνηση σχεδιασμένη ειδικά για τους στόχους σου.",
    icon: Dumbbell,
  },
];
