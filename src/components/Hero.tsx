  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center overflow-hidden pt-0 sm:pt-0">
      ...
      <div className="w-full relative z-10 text-center animate-fade-in-up px-4">
       ...
       {/* Titles */}
      <h1 className="text-5xl md:text-7xl lg:text-8xl text-primary-foreground mb-2 leading-snug tracking-normal font-aldrich">
        Redemption
      </h1>
      <h1 className="text-5xl md:text-7xl lg:text-8xl text-primary-foreground mb-4 leading-snug font-aldrich">
        Martial Arts
      </h1>
        {/* Subtitle */}
